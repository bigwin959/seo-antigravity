...
const newTranslationsPath = path.join(__dirname, 'bn_cricket_exchange_vs_sportsbook.json');
...
console.log('Successfully merged Bengali translations for cricketExchangeVsSportsbook into public/locales/bn/translation.json');
