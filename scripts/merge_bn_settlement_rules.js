...
const newContentPath = path.join(__dirname, 'bn_cricket_settlement_rules.json');
...
console.log('Successfully merged Bengali translations for Cricket Settlement Rules.');
