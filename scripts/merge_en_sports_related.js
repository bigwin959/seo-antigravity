...
const newTranslationsPath = path.join(__dirname, 'en_sports_related.json');
...
console.log('Successfully merged English sports related keys into public/locales/en/translation.json');
