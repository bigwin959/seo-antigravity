...
const newTranslationsPath = path.join(__dirname, 'en_breadcrumbs_extras.json');
...
console.log('Successfully merged English breadcrumbs into public/locales/en/translation.json');
