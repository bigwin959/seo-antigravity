...
const newTranslationsPath = path.join(__dirname, 'en_app_download_extras.json');
...
console.log('Successfully merged English app download extras into public/locales/en/translation.json');
