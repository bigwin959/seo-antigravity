...
const newContentPath = path.join(__dirname, 'en_cricket_confusing_situations.json');
...
console.log('Successfully merged English translations for Cricket Confusing Situations.');
