...
const newTranslationsPath = path.join(__dirname, 'bn_about_schema.json');
...
console.log('Successfully merged Bengali about schema into public/locales/bn/translation.json');
