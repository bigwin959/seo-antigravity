...
const newTranslationsPath = path.join(__dirname, 'bn_app_download_extras.json');
...
console.log('Successfully merged Bengali app download extras into public/locales/bn/translation.json');
