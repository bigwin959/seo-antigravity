...
const newTranslationsPath = path.join(__dirname, 'bn_breadcrumbs_extras.json');
...
console.log('Successfully merged Bengali breadcrumbs into public/locales/bn/translation.json');
