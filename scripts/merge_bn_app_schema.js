...
const newTranslationsPath = path.join(__dirname, 'bn_app_download_schema.json');
...
console.log('Successfully merged Bengali schema for appDownload into public/locales/bn/translation.json');
