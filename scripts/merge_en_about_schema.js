...
const newTranslationsPath = path.join(__dirname, 'en_about_schema.json');
...
console.log('Successfully merged English about schema into public/locales/en/translation.json');
