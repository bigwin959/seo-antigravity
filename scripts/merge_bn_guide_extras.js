...
const newTranslationsPath = path.join(__dirname, 'bn_cricket_guide_extras.json');
...
console.log('Successfully merged Bengali extras for cricketGuide into public/locales/bn/translation.json');
