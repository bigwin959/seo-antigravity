...
const newTranslationsPath = path.join(__dirname, 'bn_cricket_faq.json');
...
console.log('Successfully merged Bengali translations for cricketFAQ into public/locales/bn/translation.json');
