...
const newTranslationsPath = path.join(__dirname, 'en_cricket_faq.json');
...
console.log('Successfully merged English translations for cricketFAQ into public/locales/en/translation.json');
