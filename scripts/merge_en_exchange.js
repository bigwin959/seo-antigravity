...
const newTranslationsPath = path.join(__dirname, 'en_cricket_exchange_vs_sportsbook.json');
...
console.log('Successfully merged English translations for cricketExchangeVsSportsbook into public/locales/en/translation.json');
