...
const newTranslationsPath = path.join(__dirname, 'en_app_download_schema.json');
...
console.log('Successfully merged English schema for appDownload into public/locales/en/translation.json');
