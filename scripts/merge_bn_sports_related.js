...
const newTranslationsPath = path.join(__dirname, 'bn_sports_related.json');
...
console.log('Successfully merged Bengali sports related keys into public/locales/bn/translation.json');
