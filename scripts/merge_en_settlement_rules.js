...
const newContentPath = path.join(__dirname, 'en_cricket_settlement_rules.json');
...
console.log('Successfully merged English translations for Cricket Settlement Rules.');
