...
const newTranslationsPath = path.join(__dirname, 'en_deposit_keywords.json');
...
console.log('Successfully merged English deposit keywords into public/locales/en/translation.json');
