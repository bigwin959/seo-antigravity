...
import { OFFICIAL_DOMAIN, SITE_URL } from '../constants';
import {
    Rocket,
    Zap,
    Users,
...
const FaChaiProvider: React.FC = () => {
    ...
    return (
        <>
            <SEO
                metadata={{
                    title: t('providers.fc.seo.title'),
                    description: t('providers.fc.seo.description'),
                    keywords: safeMap(t('providers.fc.seo.keywords', { returnObjects: true })),
                    canonicalUrl: `${SITE_URL}/providers/fc`,
                    ogType: 'article',
                    ...
                    schema: {
                        ...
                        "@type": "Article",
                        "headline": t('providers.fc.seo.schema.headline'),
                        "description": t('providers.fc.seo.schema.description'),
                        "author": {
                            "@type": "Organization",
                        ...
                        "mainEntityOfPage": {
                            "@type": "WebPage",
                            "@id": "https://bigwinofficial.com/providers/fc"
                        }
                    }
                }}
            />
            ...
            <Breadcrumbs items={[
                ...
                { label: t('breadcrumbs.fc'), path: '/providers/fc' }
            ]} />
            ...
            <section className="relative py-24 bg-gradient-to-br from-[#2e1065] via-[#4c1d95] to-black overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 text-center">
                    <div className="inline-block mb-4 px-4 py-1 rounded-full border border-yellow-400/30 bg-yellow-400/10 text-yellow-400 font-bold text-sm tracking-widest uppercase animate-pulse">
                        {t('providers.fc.hero.badge')}
                    </div>
                    <h1
                        className="text-4xl md:text-6xl font-extrabold text-white mb-6 leading-tight"
                        dangerouslySetInnerHTML={{ __html: t('providers.fc.hero.title') }}
                    />

                    <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
                        {t('providers.fc.hero.subtitle')}
                    </p>
                    <a href={OFFICIAL_DOMAIN} rel="nofollow noopener noreferrer" className="inline-flex items-center bg-brand hover:bg-white text-black font-bold py-4 px-10 rounded-full transition-all shadow-[0_0_20px_rgba(255,215,0,0.3)] hover:shadow-[0_0_30px_rgba(255,215,0,0.5)] transform hover:-translate-y-1">
                        {t('providers.fc.hero.cta.play')} <Activity className="ml-2 w-5 h-5" />
                    </a>
                </div>
            </section>
            ...
            <div className="max-w-7xl mx-auto px-4 py-16 space-y-24">
                ...
                <section>
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold text-white mb-6 underline decoration-brand decoration-4 underline-offset-8"
                            dangerouslySetInnerHTML={{ __html: t('providers.fc.intro.title') }}
                        />
                        <p className="text-gray-400 text-lg max-w-3xl mx-auto leading-relaxed italic">
                            {t('providers.fc.intro.desc')}
                        </p>
                    </div>
                        ...
                        <div className="space-y-6">
                            <div className="bg-gray-800 border-l-4 border-brand p-6 rounded-r-xl">
                                <h3 className="text-brand font-bold text-xl mb-4 italic flex items-center gap-2">
                                    <Shield className="w-5 h-5" /> {t('providers.fc.intro.foundation.title')}
                                </h3>
                                <ul className="space-y-3 text-gray-300">
                                    <li className="flex justify-between border-b border-gray-700 pb-2">
                                        <span className="font-bold">{t('providers.fc.intro.foundation.foundedLabel')}</span>
                                        <span>Instant Action</span>
                                    </li>
                                    <li className="flex justify-between border-b border-gray-700 pb-2">
                                        <span className="font-bold">{t('providers.fc.intro.foundation.hqLabel')}</span>
                                        <span>Global High-Speed</span>
                                    </li>
                                    <li className="flex justify-between border-b border-gray-700 pb-2">
                                        <span className="font-bold">{t('providers.fc.intro.foundation.licensesLabel')}</span>
                                        <span>RNG Audited</span>
                                    </li>
                                    <li>
                                        <span className="font-bold block mb-1 text-brand">{t('providers.fc.intro.foundation.specLabel')}</span>
                                        <span className="text-sm">{t('providers.fc.intro.foundation.specValue')}</span>
                                    </li>
                                </ul>
                            </div>
                            <p className="text-gray-400 leading-relaxed">
                                {t('providers.fc.intro.foundation.desc')}
                            </p>
                        </div>
                        <div className="space-y-6">
                            <div className="relative rounded-2xl overflow-hidden border border-yellow-500/30 shadow-2xl bg-gray-800 p-1">
                                <img
                                    src="https://res.cloudinary.com/dmyocpyxd/image/upload/v1767689371/FC-Games-Section-Studio-Image.jpg"
                                    srcSet="https://res.cloudinary.com/dmyocpyxd/image/upload/w_300,f_auto,q_auto/v1767689371/FC-Games-Section-Studio-Image.jpg 300w, https://res.cloudinary.com/dmyocpyxd/image/upload/w_600,f_auto,q_auto/v1767689371/FC-Games-Section-Studio-Image.jpg 600w"
                            ...
                            <h3 className="text-white font-bold text-xl mb-2">{t('providers.fc.intro.philosophy.title')}</h3>
                            {safeMap(t('providers.fc.intro.philosophy.points', { returnObjects: true })).map((point: any, i: number) => (
                ...
                <section className="bg-gradient-to-r from-yellow-900/20 to-black p-8 md:p-12 rounded-3xl border border-yellow-500/30 relative overflow-hidden">
                    <div className="absolute top-0 right-0 p-8 opacity-5">
                        <Trophy className="w-64 h-64 text-brand transform rotate-12" />
                    </div>
                        ...
                        <div className="flex flex-col md:flex-row gap-12">
                            <div className="flex-1 space-y-6">
                                <h2 className="text-3xl md:text-5xl font-black text-white italic tracking-tighter uppercase underline decoration-brand decoration-8 underline-offset-4">
                                    {t('providers.fc.innovation.title')}
                                </h2>
                                <p className="text-xl text-gray-300 font-medium">
                                    {t('providers.fc.innovation.subtitle')}
                                </p>
                                <div className="space-y-4">
                                    <h3 className="text-white font-bold text-2xl border-b-2 border-brand w-fit pb-1">
                                        {t('providers.fc.innovation.features.title')}
                                    </h3>
                                    {safeMap(t('providers.fc.innovation.features.items', { returnObjects: true })).map((point: any, i: number) => (
                                        <div key={i}>
                            ...
                            <div className="flex-1 space-y-8">
                                <div className="bg-black/50 p-6 rounded-2xl border border-yellow-500/20 shadow-[0_0_30px_rgba(255,215,0,0.1)] relative">
                                    <h3 className="text-white font-bold text-xl mb-6 flex items-center gap-2">
                                        <Zap className="w-5 h-5 text-brand" /> Core Values
                                    </h3>
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        {safeMap(t('providers.fc.intro.features', { returnObjects: true })).map((item: string, i: number) => (
                                ...
                                <div className="space-y-4">
                                    <h3 className="text-white font-bold text-xl uppercase tracking-widest bg-brand/10 w-fit px-4 py-1 rounded">
                                        {t('providers.fc.innovation.mechanics.title')}
                                    </h3>
                                    <div className="space-y-3">
                                        {safeMap(t('providers.fc.innovation.mechanics.steps', { returnObjects: true })).map((step: any, i: number) => (
                                            <div key={i} className="flex gap-4 group">
                                                <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-yellow-500/20 text-brand font-bold flex items-center justify-center border border-yellow-500/30 group-hover:bg-brand group-hover:text-black transition-all">
                                                    {i + 1}
                                                </div>
                                                <div>
                ...
                <section>
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-white mb-4 uppercase tracking-tighter italic">
                            {t('providers.fc.portfolio.title')}
                        </h2>
                        <p className="text-gray-400 max-w-2xl mx-auto">
                            {t('providers.fc.portfolio.subtitle')}
                        </p>
                    </div>
                    <div className="grid lg:grid-cols-2 gap-8">
                        {safeMap(t('providers.fc.portfolio.games', { returnObjects: true })).map((game: any, i: number) => (
                            <div key={i} className="bg-gray-800 rounded-2xl p-6 border border-gray-700 hover:border-brand/40 transition-all flex flex-col md:flex-row gap-6 relative group overflow-hidden">
                                <div className="absolute top-0 right-0 p-4 opacity-0 group-hover:opacity-10 scale-150 transition-all rotate-12">
                                    <Rocket className="w-16 h-16 text-brand" />
                                </div>
                                ...
                                <div className="flex-shrink-0 w-full md:w-48 h-48 bg-gray-900 rounded-xl flex items-center justify-center relative shadow-inner border border-gray-700 overflow-hidden">
                                    <img
                                        src={game.img || "https://res.cloudinary.com/dmyocpyxd/image/upload/v1767689368/FC-%28Fa-Chai-Gaming%29-Section-Multiplier-Mechanics.jpg"}
                                        srcSet={game.img ? undefined : "https://res.cloudinary.com/dmyocpyxd/image/upload/w_200,f_auto,q_auto/v1767689368/FC-%28Fa-Chai-Gaming%29-Section-Multiplier-Mechanics.jpg 200w, https://res.cloudinary.com/dmyocpyxd/image/upload/w_400,f_auto,q_auto/v1767689368/FC-%28Fa-Chai-Gaming%29-Section-Multiplier-Mechanics.jpg 400w"}
                                ...
                                <div className="flex-1 space-y-4">
                                    <div className="flex justify-between items-start">
                                        ...
                                        <div className="text-right">
                                            <div className="text-xs text-gray-500 uppercase">{t('providers.fc.portfolio.labels.rtp')}</div>
                                    ...
                                    <div className="pt-4 flex items-center justify-between border-t border-gray-700/50 mt-auto">
                                        <div className="text-xs text-gray-500">
                                            {t('providers.fc.portfolio.labels.maxWin')}: <span className="text-brand font-bold">{game.maxWin}</span>
                                        </div>
                                        <a href={OFFICIAL_DOMAIN} className="text-brand hover:text-white font-bold text-sm uppercase flex items-center gap-1 transition-colors group">
                                            {t('providers.fc.portfolio.playNow')} <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                                        </a>
                                    </div>
                                </div>
                            </div>
                ...
                <section>
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold text-white mb-4 uppercase tracking-tighter italic">
                            {t('providers.fc.tech.title')}
                        </h2>
                        <p className="text-gray-400 max-w-2xl mx-auto italic">
                            {t('providers.fc.tech.subtitle')}
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="col-span-1 md:col-span-2 space-y-8">
                            <div className="bg-gray-800 rounded-2xl p-8 border border-gray-700 relative overflow-hidden group">
                                ...
                                <h3 className="text-2xl font-bold text-white mb-6 uppercase tracking-widest flex items-center gap-3">
                                    <ShieldCheck className="w-6 h-6 text-brand" /> {t('providers.fc.tech.fairness.title')}
                                </h3>
                                <div className="grid sm:grid-cols-3 gap-6">
                                    {safeMap(t('providers.fc.tech.fairness.points', { returnObjects: true })).map((point: any, i: number) => (
                            ...
                            <div className="bg-gray-800 rounded-2xl p-8 border border-gray-700 relative overflow-hidden group">
                                <h3 className="text-2xl font-bold text-white mb-6 uppercase tracking-widest flex items-center gap-3">
                                    <BarChart3 className="w-6 h-6 text-brand" /> {t('providers.fc.tech.infra.title')}
                                </h3>
                                <div className="grid sm:grid-cols-3 gap-6">
                                    {safeMap(t('providers.fc.tech.infra.points', { returnObjects: true })).map((point: any, i: number) => (
                                        <div key={i} className="space-y-3">
                                            <h4 className="text-brand font-black text-sm uppercase italic tracking-tighter">{point.label}</h4>
                                            <p className="text-gray-400 text-xs leading-relaxed">{point.desc}</p>
                                        </div>
                        ...
                        <div className="bg-brand rounded-2xl p-8 border border-white/20 shadow-[0_20px_50px_rgba(255,215,0,0.1)]">
                            <h3 className="text-black font-black text-2xl mb-8 uppercase italic leading-tight">
                                {t('providers.fc.tech.importance.title')}
                            </h3>
                            <div className="space-y-8">
                                <div className="space-y-4">
                                    <h4 className="text-black font-bold uppercase text-sm tracking-widest border-b border-black/20 pb-1">
                                        {t('providers.fc.tech.importance.trust.title')}
                                    </h4>
                                    <ul className="space-y-3">
                                        {safeMap(t('providers.fc.tech.importance.trust.points', { returnObjects: true })).map((point: string, i: number) => (
                                ...
                                <div className="space-y-4">
                                    <h4 className="text-black font-bold uppercase text-sm tracking-widest border-b border-black/20 pb-1">
                                        {t('providers.fc.tech.importance.benefits.title')}
                                    </h4>
                                    <ul className="space-y-3">
                                        {safeMap(t('providers.fc.tech.importance.benefits.points', { returnObjects: true })).map((point: string, i: number) => (
                                            <li key={i} className="flex items-start gap-2 text-black/80 font-medium text-sm">
                                                <CheckCircle className="w-4 h-4 flex-shrink-0 mt-0.5" /> {point}
                                            </li>
                                        ))}
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                        <div className="text-center mb-16">
                            <h2 className="text-3xl font-black text-white italic tracking-tighter uppercase mb-4">
                                {t('providers.fc.mobile.title')}
                            </h2>
                            <p className="text-gray-400 max-w-2xl italic">
                                {t('providers.fc.mobile.subtitle')}
                            </p>
                        </div>

                        <div className="grid md:grid-cols-3 gap-8 w-full mb-16">
                            {safeMap(t('providers.fc.mobile.features', { returnObjects: true })).map((feat: any, i: number) => {
                                const Icon = [MousePointer, Activity, Rocket][i];
                                return (
                        ...
                        <div className="grid md:grid-cols-2 gap-12 w-full">
                            <div className="bg-white/5 p-8 rounded-2xl border border-white/10">
                                <h3 className="text-brand font-black text-xl mb-6 flex items-center gap-3">
                                    <Smartphone className="w-6 h-6" /> {t('providers.fc.mobile.advantages.tech.title')}
                                </h3>
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-6 gap-x-8">
                                    {safeMap(t('providers.fc.mobile.advantages.tech.points', { returnObjects: true })).map((p: any, i: number) => (
                                        <div key={i}>
                            ...
                            <div className="bg-white/5 p-8 rounded-2xl border border-white/10">
                                <h3 className="text-brand font-black text-xl mb-6 flex items-center gap-3">
                                    <Layout className="w-6 h-6" /> {t('providers.fc.mobile.advantages.ux.title')}
                                </h3>
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-6 gap-x-8">
                                    {safeMap(t('providers.fc.mobile.advantages.ux.points', { returnObjects: true })).map((p: any, i: number) => (
                                        <div key={i}>
                                            <div className="text-gray-500 text-[10px] font-black uppercase tracking-widest">{p.label}</div>
                                            <div className="text-white font-bold text-sm">{p.value}</div>
                                        </div>
                ...
                <section>
                    <div className="flex flex-col lg:flex-row gap-12 items-center">
                        <div className="flex-1 space-y-8 order-2 lg:order-1">
                            <div>
                                <h2 className="text-3xl font-black text-white italic tracking-tighter uppercase mb-4">
                                    {t('providers.fc.gettingStarted.title')}
                                </h2>
                                <p className="text-gray-400 italic">
                                    {t('providers.fc.gettingStarted.subtitle')}
                                </p>
                            </div>
                            <div className="grid sm:grid-cols-2 gap-4">
                                {safeMap(t('providers.fc.gettingStarted.steps', { returnObjects: true })).map((step: string, i: number) => (
                            ...
                            <div className="bg-brand/10 border-l-4 border-brand p-5 rounded-r-xl">
                                <h4 className="text-brand font-black uppercase text-sm mb-1">{t('providers.fc.gettingStarted.disclaimer.label')}</h4>
                                <p className="text-gray-400 text-sm italic">{t('providers.fc.gettingStarted.disclaimer.text')}</p>
                            </div>
                        </div>
                        <div className="flex-1 order-1 lg:order-2 flex justify-center w-full">
                            <div className="relative w-full max-w-md aspect-[4/5] bg-gray-900 rounded-3xl border border-gray-800 shadow-2xl overflow-hidden group">
                                ...
                                <img
                                    src="https://res.cloudinary.com/dmyocpyxd/image/upload/v1767689370/FC-Games-Section-Game-UI.jpg"
                                    srcSet="https://res.cloudinary.com/dmyocpyxd/image/upload/w_300,f_auto,q_auto/v1767689370/FC-Games-Section-Game-UI.jpg 300w, https://res.cloudinary.com/dmyocpyxd/image/upload/w_500,f_auto,q_auto/v1767689370/FC-Games-Section-Game-UI.jpg 500w"
                                ...
                                <div className="absolute inset-x-0 bottom-0 p-8 z-20 space-y-4">
                                    <div className="inline-block bg-brand text-black font-black text-[10px] px-3 py-1 rounded-full uppercase tracking-tighter">Fast Loading</div>
                                    <h3 className="text-white text-3xl font-black italic tracking-tighter uppercase leading-none">Instant Rewards</h3>
                                    <p className="text-gray-400 text-sm italic">Experience the quickest rounds in the industry.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                {/* SECTION 8: FAQ */}
                <section>
                    <h2 className="text-3xl font-bold text-white mb-8 text-center">{t('providers.fc.faq.title')}</h2>
                    <div className="max-w-3xl mx-auto space-y-4">
                        {safeMap(t('providers.fc.faq.items', { returnObjects: true })).map((item: any, i: number) => (
                ...
                <section className="border border-brand/30 bg-brand/5 rounded-3xl p-8 text-center relative overflow-hidden">
                    ...
                    <h2 className="text-2xl md:text-3xl font-bold text-white mb-4 relative z-10">{t('providers.fc.responsible.title')}</h2>
                    <div className="grid sm:grid-cols-2 gap-4 max-w-3xl mx-auto relative z-10 mb-6">
                        {safeMap(t('providers.fc.responsible.tips', { returnObjects: true })).map((tip: string, i: number) => (
                    ...
                    <p className="text-gray-400 text-sm relative z-10 max-w-2xl mx-auto">
                        {t('providers.fc.responsible.disclaimer')}
                    </p>
                </section>

                {/* SECTION 10: CTA */}
                <section className="py-24 bg-gradient-to-r from-brand to-yellow-600 rounded-3xl text-center relative overflow-hidden shadow-[0_20px_50px_rgba(255,215,0,0.2)]">
                    ...
                    <div className="relative z-10 space-y-8 max-w-3xl mx-auto px-4">
                        <h2 className="text-4xl md:text-6xl font-black text-black italic tracking-tighter uppercase leading-none">
                            {t('providers.fc.cta.title')}
                        </h2>
                        <p className="text-black/80 text-xl font-medium tracking-tight">
                            Experience the speed of Fa Chai Gaming on Bigwin959.
                        </p>
                        <a href={OFFICIAL_DOMAIN} className="inline-flex items-center gap-3 bg-black hover:bg-white text-white hover:text-black font-black py-5 px-14 rounded-full transition-all shadow-2xl transform hover:-translate-y-2 uppercase tracking-widest text-lg">
                            {t('providers.fc.cta.button')} <ArrowRight className="w-6 h-6" />
                        </a>
                        <div className="flex justify-center gap-8 pt-8 flex-wrap">
                            ...
                            <div className="text-black/60 text-xs font-bold uppercase tracking-widest border border-black/20 px-3 py-1 rounded">Mobile Optimized</div>
                            <div className="text-black/60 text-xs font-bold uppercase tracking-widest border border-black/20 px-3 py-1 rounded">Fast Payouts</div>
                        </div>
                    </div>
                </section>
            </div>
